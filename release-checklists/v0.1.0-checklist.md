...
|----------|-------|-------|--------|
| CI Core (lint, build, unit) | 6 | GitHub Actions | ✅ Auto |
| E2E (no keys) | ~25 | GitHub Actions | ✅ Auto |
| E2E (with API keys) | ~10 | GitHub Actions + Secrets | ✅ Auto |
| Human Required | ~15 | Manual | 📋 Manual |
